...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Kicks" },
      { property: "og:title", content: "Kicks — Premium Sneakers for Every Step" },
      { property: "og:description", content: "Shop the latest men's, women's, and kids' sneakers at Kicks. Modern, clean, and built for movement." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@kicks" },
    ],
    links: [
      {
        rel: "stylesheet",
