...
export const Route = createFileRoute("/kids")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Discover colorful kids' sneakers at Kicks. Comfortable, durable, and ready for play." },
      { property: "og:title", content: "Kids' Sneakers — Kicks" },
      { property: "og:description", content: "Discover colorful kids' sneakers at Kicks." },
    ],
  }),
  component: KidsPage,
});
...
const featured = [
  { name: "Kicks Little Runner", price: "$75", tag: "Popular" },
  { name: "Kicks Play Max", price: "$85", tag: "New" },
  { name: "Kicks Mini Court", price: "$70", tag: null },
  { name: "Kicks Spark", price: "$80", tag: "Limited" },
];
  ...
  return (
    <div className="flex flex-col">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          <div className="relative z-10">
            ...
            <p className="mt-6 max-w-md text-lg text-primary-foreground/80">
              Colorful, comfy, and built to keep up. Explore the latest kids' sneakers.
            </p>
            <div className="mt-8">
              <Link
                to="/mens"
      ...
      <section className="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        <h2 className="font-display text-4xl text-foreground sm:text-5xl">FEATURED KIDS'</h2>
