...
export const Route = createFileRoute("/mens")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Discover the latest men's sneakers at Kicks. Performance, street style, and everyday comfort." },
      { property: "og:title", content: "Men's Sneakers — Kicks" },
      { property: "og:description", content: "Discover the latest men's sneakers at Kicks." },
    ],
  }),
  component: MensPage,
});
...
const featured = [
  { name: "Kicks Runner Pro", price: "$140", tag: "Best Seller" },
  { name: "Kicks Air Stride", price: "$165", tag: "New" },
  { name: "Kicks Court Elite", price: "$120", tag: null },
  { name: "Kicks Trail Max", price: "$155", tag: "Limited" },
];
  ...
  return (
    <div className="flex flex-col">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          <div className="relative z-10">
            ...
            <p className="mt-6 max-w-md text-lg text-primary-foreground/80">
              Built for performance and street style. Explore the latest men's drops.
            </p>
            <div className="mt-8">
              <Link
                to="/womens"
      ...
      <section className="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        <h2 className="font-display text-4xl text-foreground sm:text-5xl">FEATURED MEN'S</h2>
